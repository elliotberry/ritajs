import { RiGrammar,RiScript } from "riscript"
...
const RiTa = {
   ...
   */
  alliterationsSync(word, options) {
  ...
  pos(word, options) {
    if (options && "inline" in options) {
      throw new Error("Use RiTa.posInline() instead")
    }
...
export { RiTa }
export {default as RiMarkov} from "./markov.js"
